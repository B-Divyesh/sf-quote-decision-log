...
function shell(content: string, section = 'home'): string {
  return `<div class="shell">
    ...
    <footer><span>Quote review and client decisions for tiny agencies.</span><span><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></span><span>Built by Param Factory · v1.0.3</span></footer>
